/*
 * Stepper3.cpp - Stepper library for Wiring/Arduino - Version 1.1.0
 *
 ...
 */
Stepper3::Stepper3(int number_of_steps, int motor_pin_1, int motor_pin_2)
{
...
void Stepper3::step(int steps_to_move)
{
  ...
  while (steps_left > 0)
  {
    ...
    if (now - this->last_step_time >= this->step_delay)
    {
      ...
      steps_left--;
      // step the motor to step number 0, 1, ..., {8 or 10}
      if (this->pin_count == 5)
